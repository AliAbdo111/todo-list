    ...
    export class UserService {
      ...
      async create(createUserDto: CreateUserDto) {
        ...
        const userScraping= await this.scrapingService.scrapeLinkedInProfile(createUserDto.linkedIn_url)
      console.log(userScraping) 
        const res = await this.userRepository.save({ ...createUserDto, password: hash ,name:userScraping})
        return {
          statusCode: 200,
